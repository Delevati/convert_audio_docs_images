...
def convert_mov_to_mp4(input_file, output_file, bitrate=None, resolution=None):
...
if __name__ == "__main__":
    input_file = '/caminho/do/seu/video.mov'
    ...
    convert_mov_to_mp4(input_file, output_file, bitrate, resolution)
